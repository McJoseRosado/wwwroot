...
namespace RenuOil
{
    public partial class OilFiltrationAccounts : System.Web.UI.Page
    {
        #region Members
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var accounts = from a in _db.Account
                           //where a.AccountType == "OilFiltration"
        ...
        {
            Response.Redirect("~/EditAccount.aspx?acctId=0&type=OilFiltration");
        }
        #endregion
