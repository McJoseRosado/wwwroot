<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Blueprint.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="RenuOil.Login" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="slideshowContent" runat="server">
    <div class="static-block">
        <img src="images/image-static.jpg" alt="" />
    </div>
        ...
        <center>
            <div class="loginBox">
                <asp:Panel ID="pnlLogin" runat="server" DefaultButton="lnkBtnLogin">
                    ...
                    <hr />
                    <asp:LinkButton ID="lnkBtnLogin" runat="server" CssClass="buttonNoFloat default" OnClick="lnkBtnLogin_Click"><span>SIGN IN
                        <img src="images/arrow_grey.png" alt="" class="readmore" /></span></asp:LinkButton>
                    <div class="clear">
                    </div>
                </asp:Panel>
                <a href="Home.aspx" style="font-size: x-small;">Can't access your account?</a>
            </div>
            <div id="messages" class="error" visible="false" runat="server">
            </div>
        </center>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="featuresContent" runat="server">
    <ul>
        ...
        <li class="first">
            ...
            <p>About 80% of what Americans throw away is recyclable.</p>
        </li>
        <!-- Features Box #2 -->
        <li>
            ...
            <p>If all newspaper was recycled, we could save about 250,000,000 trees each year!</p>
        </li>
        <!-- Features Box #3 -->
        <li>
            <img src="images/processing.png" class="alignleft" alt="" />
            <h4><a href="#">Green Fuel</a></h4>
            <div class="clear">
            </div>
            <p>Biodiesel is biodegradable, nontoxic, and essentially free of sulfur and aromatics.</p>
        </li>
        <!-- Features Box #4 -->
        <li class="last">
            ...
            <p>We'll collect 100% of your recyclables.</p>
        </li>
    </ul>
</asp:Content>
