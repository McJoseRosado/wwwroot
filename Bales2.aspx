<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBale.aspx.cs" Inherits="RenuOil.Bales"
        ...
        <div class="main_row row">
            <form id="Form1" runat="server">
                <div class="col-sm-12">
                    ...
                    <h3>
                        <asp:Button ID="Button1" runat="server" OnClick="btnCancel_Click" Text="Back" CssClass="btn btn-default btn-info backToHome_button" />Bales Available</h3>
                    <hr />
