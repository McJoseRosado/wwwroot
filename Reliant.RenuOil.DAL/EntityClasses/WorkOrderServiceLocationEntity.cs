...
namespace Reliant.RenuOil.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public WorkOrderServiceLocationEntity()
		{
			InitClassEmpty(null);
		}
		...
		public WorkOrderServiceLocationEntity(System.Int32 workOrderServiceLocationId)
		{
			InitClassFetch(workOrderServiceLocationId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="workOrderServiceLocationId">PK value for WorkOrderServiceLocation which data should be fetched into this WorkOrderServiceLocation object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public WorkOrderServiceLocationEntity(System.Int32 workOrderServiceLocationId, IPrefetchPath prefetchPathToUse)
		{
			InitClassFetch(workOrderServiceLocationId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="workOrderServiceLocationId">PK value for WorkOrderServiceLocation which data should be fetched into this WorkOrderServiceLocation object</param>
		/// <param name="validator">The custom validator object for this WorkOrderServiceLocationEntity</param>
		public WorkOrderServiceLocationEntity(System.Int32 workOrderServiceLocationId, IValidator validator)
		{
			InitClassFetch(workOrderServiceLocationId, validator, null);
		}
		...
		public bool FetchUsingPK(System.Int32 workOrderServiceLocationId)
		{
			return FetchUsingPK(workOrderServiceLocationId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 workOrderServiceLocationId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(workOrderServiceLocationId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 workOrderServiceLocationId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return Fetch(workOrderServiceLocationId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 workOrderServiceLocationId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(workOrderServiceLocationId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.WorkOrderServiceLocationId, null, null, null);
		}
		...
		public virtual Reliant.RenuOil.DAL.CollectionClasses.AssetReclamationServiceCollection GetMultiAssetReclamationService(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedAssetReclamationService || forceFetch || _alwaysFetchAssetReclamationService) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_assetReclamationService.GetMultiManyToOne(null, null, this, filter);
		...
		public virtual Reliant.RenuOil.DAL.CollectionClasses.DeepFryerServiceCollection GetMultiDeepFryerService(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedDeepFryerService || forceFetch || _alwaysFetchDeepFryerService) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_deepFryerService.GetMultiManyToOne(null, null, null, null, this, filter);
		...
		public virtual Reliant.RenuOil.DAL.CollectionClasses.RecycleServiceCollection GetMultiRecycleService(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedRecycleService || forceFetch || _alwaysFetchRecycleService) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				_recycleService.GetMultiManyToOne(null, this, filter);
		...
		public Reliant.RenuOil.DAL.CollectionClasses.DeepFryerCollection GetMultiDeepFryerCollectionViaDeepFryerService(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedDeepFryerCollectionViaDeepFryerService || forceFetch || _alwaysFetchDeepFryerCollectionViaDeepFryerService) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				...
				filter.Add(new FieldCompareValuePredicate(WorkOrderServiceLocationFields.WorkOrderServiceLocationId, ComparisonOperator.Equal, this.WorkOrderServiceLocationId, "WorkOrderServiceLocationEntity__"));
		...
		public virtual ServiceLocationEntity GetSingleServiceLocation(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(WorkOrderServiceLocationEntity.Relations.ServiceLocationEntityUsingServiceLocationId);
		...
		public virtual WorkOrderEntity GetSingleWorkOrder(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(WorkOrderServiceLocationEntity.Relations.WorkOrderEntityUsingWorkOrderId);
		...
		{
			WorkOrderServiceLocationDAO dao = (WorkOrderServiceLocationDAO)CreateDAOInstance();
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 workOrderServiceLocationId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(workOrderServiceLocationId, prefetchPathToUse, null, null);
		...
		private void SetupSyncServiceLocation(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _serviceLocation, new PropertyChangedEventHandler( OnServiceLocationPropertyChanged ), "ServiceLocation", WorkOrderServiceLocationEntity.Relations.ServiceLocationEntityUsingServiceLocationId, true, ref _alreadyFetchedServiceLocation, new string[] {  } );
			}
		}
		...
		private void SetupSyncWorkOrder(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _workOrder, new PropertyChangedEventHandler( OnWorkOrderPropertyChanged ), "WorkOrder", WorkOrderServiceLocationEntity.Relations.WorkOrderEntityUsingWorkOrderId, true, ref _alreadyFetchedWorkOrder, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 workOrderServiceLocationId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				IDao dao = this.CreateDAOInstance();
				base.Fields[(int)WorkOrderServiceLocationFieldIndex.WorkOrderServiceLocationId].ForcedCurrentValueWrite(workOrderServiceLocationId);
		...
		{
			return new WorkOrderServiceLocationEntityFactory();
		}
		...
		public static IPrefetchPathElement PrefetchPathAssetReclamationService
		{
			get
			{
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.AssetReclamationServiceCollection(),
					(IEntityRelation)GetRelationsForField("AssetReclamationService")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity, (int)Reliant.RenuOil.DAL.EntityType.AssetReclamationServiceEntity, 0, null, null, null, "AssetReclamationService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathDeepFryerService
		{
			get
			{
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.DeepFryerServiceCollection(),
					(IEntityRelation)GetRelationsForField("DeepFryerService")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity, (int)Reliant.RenuOil.DAL.EntityType.DeepFryerServiceEntity, 0, null, null, null, "DeepFryerService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathRecycleService
		{
			get
			{
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.RecycleServiceCollection(),
					(IEntityRelation)GetRelationsForField("RecycleService")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity, (int)Reliant.RenuOil.DAL.EntityType.RecycleServiceEntity, 0, null, null, null, "RecycleService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathDeepFryerCollectionViaDeepFryerService
		{
			get
			{
				...
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.DeepFryerCollection(), intermediateRelation,
					(int)Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity, (int)Reliant.RenuOil.DAL.EntityType.DeepFryerEntity, 0, null, null, GetRelationsForField("DeepFryerCollectionViaDeepFryerService"), "DeepFryerCollectionViaDeepFryerService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathEmployeeCollectionViaDeepFryerService
		{
			get
			{
				...
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.EmployeeCollection(), intermediateRelation,
					(int)Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity, (int)Reliant.RenuOil.DAL.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaDeepFryerService"), "EmployeeCollectionViaDeepFryerService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathServiceLocationCollectionViaDeepFryerService
		{
			get
			{
				...
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.ServiceLocationCollection(), intermediateRelation,
					(int)Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity, (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationEntity, 0, null, null, GetRelationsForField("ServiceLocationCollectionViaDeepFryerService"), "ServiceLocationCollectionViaDeepFryerService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathServiceLocation
		{
			get
			{
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.ServiceLocationCollection(),
					(IEntityRelation)GetRelationsForField("ServiceLocation")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity, (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationEntity, 0, null, null, null, "ServiceLocation", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathWorkOrder
		{
			get
			{
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.WorkOrderCollection(),
					(IEntityRelation)GetRelationsForField("WorkOrder")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity, (int)Reliant.RenuOil.DAL.EntityType.WorkOrderEntity, 0, null, null, null, "WorkOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return "WorkOrderServiceLocationEntity";}
		}
		...
		public virtual System.Int32 WorkOrderServiceLocationId
		{
			...
			set	{ SetValue((int)WorkOrderServiceLocationFieldIndex.WorkOrderServiceLocationId, value, true); }
		}
		...
		public virtual System.Int32 WorkOrderId
		{
			...
			set	{ SetValue((int)WorkOrderServiceLocationFieldIndex.WorkOrderId, value, true); }
		}
		...
		public virtual System.Int32 ServiceLocationId
		{
			...
			set	{ SetValue((int)WorkOrderServiceLocationFieldIndex.ServiceLocationId, value, true); }
		}
		...
		public virtual System.String Notes
		{
			...
			set	{ SetValue((int)WorkOrderServiceLocationFieldIndex.Notes, value, true); }
		}
		...
		public virtual System.String UncategorizedItems
		{
			...
			set	{ SetValue((int)WorkOrderServiceLocationFieldIndex.UncategorizedItems, value, true); }
		}
			...
			set
			{
				...
				else
				{
					...
					else
					{
						...
						{
							((IEntity)value).SetRelatedEntity(this, "WorkOrderServiceLocation");
						}
					}
				}
			}
