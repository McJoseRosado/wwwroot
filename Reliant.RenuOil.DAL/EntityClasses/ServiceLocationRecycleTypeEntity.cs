...
namespace Reliant.RenuOil.DAL.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ServiceLocationRecycleType'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ServiceLocationRecycleTypeEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ServiceLocationRecycleTypeEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ServiceLocationRecycleTypeEntity()
		{
			InitClassEmpty(null);
		}
		...
		/// <summary>CTor</summary>
		/// <param name="serviceLocationRecycleTypeId">PK value for ServiceLocationRecycleType which data should be fetched into this ServiceLocationRecycleType object</param>
		public ServiceLocationRecycleTypeEntity(System.Int32 serviceLocationRecycleTypeId)
		{
			InitClassFetch(serviceLocationRecycleTypeId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="serviceLocationRecycleTypeId">PK value for ServiceLocationRecycleType which data should be fetched into this ServiceLocationRecycleType object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public ServiceLocationRecycleTypeEntity(System.Int32 serviceLocationRecycleTypeId, IPrefetchPath prefetchPathToUse)
		{
			InitClassFetch(serviceLocationRecycleTypeId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="serviceLocationRecycleTypeId">PK value for ServiceLocationRecycleType which data should be fetched into this ServiceLocationRecycleType object</param>
		/// <param name="validator">The custom validator object for this ServiceLocationRecycleTypeEntity</param>
		public ServiceLocationRecycleTypeEntity(System.Int32 serviceLocationRecycleTypeId, IValidator validator)
		{
			InitClassFetch(serviceLocationRecycleTypeId, validator, null);
		}
		...
		{
			switch((ServiceLocationRecycleTypeFieldIndex)fieldIndex)
			{
				case ServiceLocationRecycleTypeFieldIndex.RecycleTypeId:
					DesetupSyncRecycleType(true, false);
					_alreadyFetchedRecycleType = false;
					break;
				case ServiceLocationRecycleTypeFieldIndex.ServiceLocationId:
		...
		{
			return ServiceLocationRecycleTypeEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "RecycleType":
					toReturn.Add(ServiceLocationRecycleTypeEntity.Relations.RecycleTypeEntityUsingRecycleTypeId);
					break;
				case "ServiceLocation":
					toReturn.Add(ServiceLocationRecycleTypeEntity.Relations.ServiceLocationEntityUsingServiceLocationId);
					break;
		...
		public bool FetchUsingPK(System.Int32 serviceLocationRecycleTypeId)
		{
			return FetchUsingPK(serviceLocationRecycleTypeId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 serviceLocationRecycleTypeId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(serviceLocationRecycleTypeId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 serviceLocationRecycleTypeId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return Fetch(serviceLocationRecycleTypeId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 serviceLocationRecycleTypeId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(serviceLocationRecycleTypeId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.ServiceLocationRecycleTypeId, null, null, null);
		}
		...
		public bool TestOriginalFieldValueForNull(ServiceLocationRecycleTypeFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ServiceLocationRecycleTypeFieldIndex fieldIndex)
		{
		...
		{
			return new ServiceLocationRecycleTypeRelations().GetAllRelations();
		}
		...
		public virtual RecycleTypeEntity GetSingleRecycleType(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(ServiceLocationRecycleTypeEntity.Relations.RecycleTypeEntityUsingRecycleTypeId);
		...
		public virtual ServiceLocationEntity GetSingleServiceLocation(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(ServiceLocationRecycleTypeEntity.Relations.ServiceLocationEntityUsingServiceLocationId);
		...
		{
			ServiceLocationRecycleTypeDAO dao = (ServiceLocationRecycleTypeDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(Reliant.RenuOil.DAL.EntityType.ServiceLocationRecycleTypeEntity);
		}
		...
		/// <param name="serviceLocationRecycleTypeId">PK value for ServiceLocationRecycleType which data should be fetched into this ServiceLocationRecycleType object</param>
		/// <param name="validator">The validator object for this ServiceLocationRecycleTypeEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 serviceLocationRecycleTypeId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(serviceLocationRecycleTypeId, prefetchPathToUse, null, null);
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ServiceLocationRecycleTypeId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		private void SetupSyncRecycleType(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _recycleType, new PropertyChangedEventHandler( OnRecycleTypePropertyChanged ), "RecycleType", ServiceLocationRecycleTypeEntity.Relations.RecycleTypeEntityUsingRecycleTypeId, true, ref _alreadyFetchedRecycleType, new string[] {  } );
			}
		}
		...
		private void SetupSyncServiceLocation(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _serviceLocation, new PropertyChangedEventHandler( OnServiceLocationPropertyChanged ), "ServiceLocation", ServiceLocationRecycleTypeEntity.Relations.ServiceLocationEntityUsingServiceLocationId, true, ref _alreadyFetchedServiceLocation, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 serviceLocationRecycleTypeId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				IDao dao = this.CreateDAOInstance();
				base.Fields[(int)ServiceLocationRecycleTypeFieldIndex.ServiceLocationRecycleTypeId].ForcedCurrentValueWrite(serviceLocationRecycleTypeId);
		...
		{
			return DAOFactory.CreateServiceLocationRecycleTypeDAO();
		}
		...
		{
			return new ServiceLocationRecycleTypeEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static ServiceLocationRecycleTypeRelations Relations
		{
			get	{ return new ServiceLocationRecycleTypeRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathRecycleType
		{
			get
			{
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.RecycleTypeCollection(),
					(IEntityRelation)GetRelationsForField("RecycleType")[0], (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationRecycleTypeEntity, (int)Reliant.RenuOil.DAL.EntityType.RecycleTypeEntity, 0, null, null, null, "RecycleType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathServiceLocation
		{
			get
			{
				return new PrefetchPathElement(new Reliant.RenuOil.DAL.CollectionClasses.ServiceLocationCollection(),
					(IEntityRelation)GetRelationsForField("ServiceLocation")[0], (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationRecycleTypeEntity, (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationEntity, 0, null, null, null, "ServiceLocation", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return "ServiceLocationRecycleTypeEntity";}
		}
		...
		{
			get { return ServiceLocationRecycleTypeEntity.CustomProperties;}
		}
		...
		{
			get { return ServiceLocationRecycleTypeEntity.FieldsCustomProperties;}
		}

		/// <summary> The ServiceLocationRecycleTypeId property of the Entity ServiceLocationRecycleType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ServiceLocationRecycleType"."ServiceLocationRecycleTypeId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 ServiceLocationRecycleTypeId
		{
			get { return (System.Int32)GetValue((int)ServiceLocationRecycleTypeFieldIndex.ServiceLocationRecycleTypeId, true); }
			set	{ SetValue((int)ServiceLocationRecycleTypeFieldIndex.ServiceLocationRecycleTypeId, value, true); }
		}
		/// <summary> The RecycleTypeId property of the Entity ServiceLocationRecycleType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ServiceLocationRecycleType"."RecycleTypeId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 RecycleTypeId
		{
			get { return (System.Int32)GetValue((int)ServiceLocationRecycleTypeFieldIndex.RecycleTypeId, true); }
			set	{ SetValue((int)ServiceLocationRecycleTypeFieldIndex.RecycleTypeId, value, true); }
		}
		/// <summary> The ServiceLocationId property of the Entity ServiceLocationRecycleType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ServiceLocationRecycleType"."ServiceLocationId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 ServiceLocationId
		{
			get { return (System.Int32)GetValue((int)ServiceLocationRecycleTypeFieldIndex.ServiceLocationId, true); }
			set	{ SetValue((int)ServiceLocationRecycleTypeFieldIndex.ServiceLocationId, value, true); }
		}
		/// <summary> The IsActive property of the Entity ServiceLocationRecycleType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ServiceLocationRecycleType"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)ServiceLocationRecycleTypeFieldIndex.IsActive, true); }
			set	{ SetValue((int)ServiceLocationRecycleTypeFieldIndex.IsActive, value, true); }
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_recycleType != null)
						{
							_recycleType.UnsetRelatedEntity(this, "ServiceLocationRecycleType");
						}
					}
					else
					{
						...
						{
							((IEntity)value).SetRelatedEntity(this, "ServiceLocationRecycleType");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_serviceLocation != null)
						{
							_serviceLocation.UnsetRelatedEntity(this, "ServiceLocationRecycleType");
						}
					}
					else
					{
		...
		{ 
			get { return (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationRecycleTypeEntity; }
		}
		#endregion
