...
namespace Reliant.RenuOil.DAL.EntityClasses
{
			...
			
	{
		...
		public UserTypeEntity():base("UserTypeEntity")
		{
		...
		public UserTypeEntity(IEntityFields2 fields):base("UserTypeEntity")
		{
		...
		public UserTypeEntity(IValidator validator):base("UserTypeEntity")
		{
		...
		public UserTypeEntity(System.Int32 userTypeId):base("UserTypeEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this UserTypeEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public UserTypeEntity(System.Int32 userTypeId, IValidator validator):base("UserTypeEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.UserTypeId = userTypeId;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoUser()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(UserFields.UserTypeId, null, ComparisonOperator.Equal, this.UserTypeId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(UserTypeEntityFactory));
		}
#if !CF
		...
		public static IPrefetchPathElement2 PrefetchPathUser
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),
					(IEntityRelation)GetRelationsForField("User")[0], (int)Reliant.RenuOil.DAL.EntityType.UserTypeEntity, (int)Reliant.RenuOil.DAL.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public virtual System.Int32 UserTypeId
		{
			...
			set	{ SetValue((int)UserTypeFieldIndex.UserTypeId, value); }
		}
		...
		public virtual System.String Description
		{
			...
			set	{ SetValue((int)UserTypeFieldIndex.Description, value); }
		}
