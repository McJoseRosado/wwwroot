...
namespace Reliant.RenuOil.DAL.EntityClasses
{
			...
			
	{
		...
		public ServiceLocationRecycleTypeEntity():base("ServiceLocationRecycleTypeEntity")
		{
		...
		public ServiceLocationRecycleTypeEntity(IEntityFields2 fields):base("ServiceLocationRecycleTypeEntity")
		{
		...
		public ServiceLocationRecycleTypeEntity(IValidator validator):base("ServiceLocationRecycleTypeEntity")
		{
		...
		public ServiceLocationRecycleTypeEntity(System.Int32 serviceLocationRecycleTypeId):base("ServiceLocationRecycleTypeEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.ServiceLocationRecycleTypeId = serviceLocationRecycleTypeId;
		}
		...
		/// <param name="validator">The custom validator object for this ServiceLocationRecycleTypeEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ServiceLocationRecycleTypeEntity(System.Int32 serviceLocationRecycleTypeId, IValidator validator):base("ServiceLocationRecycleTypeEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ServiceLocationRecycleTypeId = serviceLocationRecycleTypeId;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ServiceLocationRecycleTypeEntityFactory));
		}
#if !CF
		...
		public static IPrefetchPathElement2 PrefetchPathRecycleType
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RecycleTypeEntityFactory))),
					(IEntityRelation)GetRelationsForField("RecycleType")[0], (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationRecycleTypeEntity, (int)Reliant.RenuOil.DAL.EntityType.RecycleTypeEntity, 0, null, null, null, null, "RecycleType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathServiceLocation
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ServiceLocationEntityFactory))),
					(IEntityRelation)GetRelationsForField("ServiceLocation")[0], (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationRecycleTypeEntity, (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationEntity, 0, null, null, null, null, "ServiceLocation", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public virtual System.Int32 ServiceLocationRecycleTypeId
		{
			...
			set	{ SetValue((int)ServiceLocationRecycleTypeFieldIndex.ServiceLocationRecycleTypeId, value); }
		}
		...
		public virtual System.Int32 RecycleTypeId
		{
			...
			set	{ SetValue((int)ServiceLocationRecycleTypeFieldIndex.RecycleTypeId, value); }
		}
		...
		public virtual System.Int32 ServiceLocationId
		{
			...
			set	{ SetValue((int)ServiceLocationRecycleTypeFieldIndex.ServiceLocationId, value); }
		}
		...
		public virtual System.Boolean IsActive
		{
			...
			set	{ SetValue((int)ServiceLocationRecycleTypeFieldIndex.IsActive, value); }
		}
			...
			set
			{
				...
				else
				{
					...
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "ServiceLocationRecycleType");
						}
					}
				}
			}
