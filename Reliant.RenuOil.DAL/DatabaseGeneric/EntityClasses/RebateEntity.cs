...
namespace Reliant.RenuOil.DAL.EntityClasses
{
			...
			
	{
		...
		public RebateEntity():base("RebateEntity")
		{
		...
		public RebateEntity(IEntityFields2 fields):base("RebateEntity")
		{
		...
		public RebateEntity(IValidator validator):base("RebateEntity")
		{
		...
		public RebateEntity(System.Int32 rebateId):base("RebateEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this RebateEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public RebateEntity(System.Int32 rebateId, IValidator validator):base("RebateEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.RebateId = rebateId;
		}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entity of type 'RebateType' to this entity. Use DataAccessAdapter.FetchNewEntity() to fetch this related entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoRebateType()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(RebateTypeFields.RebateTypeId, null, ComparisonOperator.Equal, this.RebateTypeId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(RebateEntityFactory));
		}
#if !CF
		...
		private void SetupSyncAccount(IEntity2 relatedEntity)
		{
			if(_account!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _account, new PropertyChangedEventHandler( OnAccountPropertyChanged ), "Account", RebateEntity.Relations.AccountEntityUsingAccountId, true, new string[] {  } );
			}
		}
		...
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncRebateType(IEntity2 relatedEntity)
		{
			if(_rebateType!=relatedEntity)
			{
				DesetupSyncRebateType(true, true);
				_rebateType = (RebateTypeEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _rebateType, new PropertyChangedEventHandler( OnRebateTypePropertyChanged ), "RebateType", RebateEntity.Relations.RebateTypeEntityUsingRebateTypeId, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncUser(IEntity2 relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", RebateEntity.Relations.UserEntityUsingEnteredByUserId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAccount
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AccountEntityFactory))),
					(IEntityRelation)GetRelationsForField("Account")[0], (int)Reliant.RenuOil.DAL.EntityType.RebateEntity, (int)Reliant.RenuOil.DAL.EntityType.AccountEntity, 0, null, null, null, null, "Account", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathRebateType
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RebateTypeEntityFactory))),
					(IEntityRelation)GetRelationsForField("RebateType")[0], (int)Reliant.RenuOil.DAL.EntityType.RebateEntity, (int)Reliant.RenuOil.DAL.EntityType.RebateTypeEntity, 0, null, null, null, null, "RebateType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUser
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),
					(IEntityRelation)GetRelationsForField("User")[0], (int)Reliant.RenuOil.DAL.EntityType.RebateEntity, (int)Reliant.RenuOil.DAL.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public virtual System.Int32 RebateId
		{
			...
			set	{ SetValue((int)RebateFieldIndex.RebateId, value); }
		}
		...
		public virtual System.Int32 RebateTypeId
		{
			...
			set	{ SetValue((int)RebateFieldIndex.RebateTypeId, value); }
		}
		...
		public virtual System.DateTime RebateDate
		{
			...
			set	{ SetValue((int)RebateFieldIndex.RebateDate, value); }
		}
		...
		public virtual System.Int32 AccountId
		{
			...
			set	{ SetValue((int)RebateFieldIndex.AccountId, value); }
		}
		...
		public virtual System.Decimal Amount
		{
			...
			set	{ SetValue((int)RebateFieldIndex.Amount, value); }
		}
		...
		public virtual System.Int32 EnteredByUserId
		{
			...
			set	{ SetValue((int)RebateFieldIndex.EnteredByUserId, value); }
		}
		...
		public virtual System.DateTime EnteredDate
		{
			...
			set	{ SetValue((int)RebateFieldIndex.EnteredDate, value); }
		}
			...
			set
			{
				...
				else
				{
					...
					else
					{
						if(_account!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "Rebate");
						}
					}
				}
			}
		...
		/// <summary> Gets / sets related entity of type 'RebateTypeEntity' which has to be set using a fetch action earlier. If no related entity
		/// is set for this property, null is returned. This property is not visible in databound grids.</summary>
		[Browsable(false)]
