...
namespace Reliant.RenuOil.DAL.EntityClasses
{
			...
			
	{
		...
		private EntityCollection<AssetTypeEntity> _assetType;
		...
		public AssetCategoryEntity():base("AssetCategoryEntity")
		{
		...
		public AssetCategoryEntity(IEntityFields2 fields):base("AssetCategoryEntity")
		{
		...
		public AssetCategoryEntity(IValidator validator):base("AssetCategoryEntity")
		{
		...
		public AssetCategoryEntity(System.Int32 assetCategoryId):base("AssetCategoryEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this AssetCategoryEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AssetCategoryEntity(System.Int32 assetCategoryId, IValidator validator):base("AssetCategoryEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.AssetCategoryId = assetCategoryId;
		}
		...
		protected AssetCategoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_assetType = (EntityCollection<AssetTypeEntity>)info.GetValue("_assetType", typeof(EntityCollection<AssetTypeEntity>));
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "AssetType":
					this.AssetType.Add((AssetTypeEntity)relatedEntity);
					break;
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "AssetType":
					base.PerformRelatedEntityRemoval(this.AssetType, relatedEntity, signalRelatedEntityManyToOne);
					break;
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_assetType", ((_assetType!=null) && (_assetType.Count>0) && !this.MarkedForDeletion)?_assetType:null);
		...
		public virtual IRelationPredicateBucket GetRelationInfoAssetType()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(AssetTypeFields.AssetCategoryId, null, ComparisonOperator.Equal, this.AssetCategoryId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AssetCategoryEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._assetType);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._assetType = (EntityCollection<AssetTypeEntity>) collectionsQueue.Dequeue();
		...
		public static IPrefetchPathElement2 PrefetchPathAssetType
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<AssetTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AssetTypeEntityFactory))),
					(IEntityRelation)GetRelationsForField("AssetType")[0], (int)Reliant.RenuOil.DAL.EntityType.AssetCategoryEntity, (int)Reliant.RenuOil.DAL.EntityType.AssetTypeEntity, 0, null, null, null, null, "AssetType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public virtual System.Int32 AssetCategoryId
		{
			...
			set	{ SetValue((int)AssetCategoryFieldIndex.AssetCategoryId, value); }
		}
		...
		public virtual System.String Name
		{
			...
			set	{ SetValue((int)AssetCategoryFieldIndex.Name, value); }
		}
		...
		public virtual System.String Description
		{
			...
			set	{ SetValue((int)AssetCategoryFieldIndex.Description, value); }
		}
		...
		public virtual System.String SpanishLabel
		{
			...
			set	{ SetValue((int)AssetCategoryFieldIndex.SpanishLabel, value); }
		}
		...
		public virtual System.Boolean IsActive
		{
			...
			set	{ SetValue((int)AssetCategoryFieldIndex.IsActive, value); }
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'AssetTypeEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		[TypeContainedAttribute(typeof(AssetTypeEntity))]
		public virtual EntityCollection<AssetTypeEntity> AssetType
		{
			get
			{
				if(_assetType==null)
				{
					_assetType = new EntityCollection<AssetTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AssetTypeEntityFactory)));
