...
namespace Reliant.RenuOil.DAL.EntityClasses
{
			...
			
	{
		...
		public WorkOrderEmployeeEntity():base("WorkOrderEmployeeEntity")
		{
		...
		public WorkOrderEmployeeEntity(IEntityFields2 fields):base("WorkOrderEmployeeEntity")
		{
		...
		public WorkOrderEmployeeEntity(IValidator validator):base("WorkOrderEmployeeEntity")
		{
		...
		public WorkOrderEmployeeEntity(System.Int32 workOrderEmployeeId):base("WorkOrderEmployeeEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this WorkOrderEmployeeEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public WorkOrderEmployeeEntity(System.Int32 workOrderEmployeeId, IValidator validator):base("WorkOrderEmployeeEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.WorkOrderEmployeeId = workOrderEmployeeId;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoAssetReclamationService()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(AssetReclamationServiceFields.WorkOrderServiceLocationId, null, ComparisonOperator.Equal, this.WorkOrderEmployeeId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(DeepFryerServiceFields.WorkOrderServiceLocationId, null, ComparisonOperator.Equal, this.WorkOrderEmployeeId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(RecycleServiceFields.WorkOrderServiceLocationId, null, ComparisonOperator.Equal, this.WorkOrderEmployeeId));
			return bucket;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoDeepFryerCollectionViaDeepFryerService()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(WorkOrderEmployeeFields.WorkOrderEmployeeId, null, ComparisonOperator.Equal, this.WorkOrderEmployeeId, "WorkOrderEmployeeEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ServiceLocationFields.ServiceLocationId, null, ComparisonOperator.Equal, this.EmployeeId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderEmployeeEntityFactory));
		}
#if !CF
		...
		private void SetupSyncServiceLocation(IEntity2 relatedEntity)
		{
			if(_serviceLocation!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _serviceLocation, new PropertyChangedEventHandler( OnServiceLocationPropertyChanged ), "ServiceLocation", WorkOrderEmployeeEntity.Relations.ServiceLocationEntityUsingEmployeeId, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncWorkOrder(IEntity2 relatedEntity)
		{
			if(_workOrder!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _workOrder, new PropertyChangedEventHandler( OnWorkOrderPropertyChanged ), "WorkOrder", WorkOrderEmployeeEntity.Relations.WorkOrderEntityUsingWorkOrderId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAssetReclamationService
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<AssetReclamationServiceEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AssetReclamationServiceEntityFactory))),
					(IEntityRelation)GetRelationsForField("AssetReclamationService")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderEmployeeEntity, (int)Reliant.RenuOil.DAL.EntityType.AssetReclamationServiceEntity, 0, null, null, null, null, "AssetReclamationService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDeepFryerService
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<DeepFryerServiceEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DeepFryerServiceEntityFactory))),
					(IEntityRelation)GetRelationsForField("DeepFryerService")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderEmployeeEntity, (int)Reliant.RenuOil.DAL.EntityType.DeepFryerServiceEntity, 0, null, null, null, null, "DeepFryerService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathRecycleService
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<RecycleServiceEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RecycleServiceEntityFactory))),
					(IEntityRelation)GetRelationsForField("RecycleService")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderEmployeeEntity, (int)Reliant.RenuOil.DAL.EntityType.RecycleServiceEntity, 0, null, null, null, null, "RecycleService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDeepFryerCollectionViaDeepFryerService
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<DeepFryerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DeepFryerEntityFactory))), intermediateRelation,
					(int)Reliant.RenuOil.DAL.EntityType.WorkOrderEmployeeEntity, (int)Reliant.RenuOil.DAL.EntityType.DeepFryerEntity, 0, null, null, GetRelationsForField("DeepFryerCollectionViaDeepFryerService"), null, "DeepFryerCollectionViaDeepFryerService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaDeepFryerService
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)Reliant.RenuOil.DAL.EntityType.WorkOrderEmployeeEntity, (int)Reliant.RenuOil.DAL.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaDeepFryerService"), null, "EmployeeCollectionViaDeepFryerService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathServiceLocationCollectionViaDeepFryerService
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ServiceLocationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ServiceLocationEntityFactory))), intermediateRelation,
					(int)Reliant.RenuOil.DAL.EntityType.WorkOrderEmployeeEntity, (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationEntity, 0, null, null, GetRelationsForField("ServiceLocationCollectionViaDeepFryerService"), null, "ServiceLocationCollectionViaDeepFryerService", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathServiceLocation
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ServiceLocationEntityFactory))),
					(IEntityRelation)GetRelationsForField("ServiceLocation")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderEmployeeEntity, (int)Reliant.RenuOil.DAL.EntityType.ServiceLocationEntity, 0, null, null, null, null, "ServiceLocation", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathWorkOrder
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderEntityFactory))),
					(IEntityRelation)GetRelationsForField("WorkOrder")[0], (int)Reliant.RenuOil.DAL.EntityType.WorkOrderEmployeeEntity, (int)Reliant.RenuOil.DAL.EntityType.WorkOrderEntity, 0, null, null, null, null, "WorkOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public virtual System.Int32 WorkOrderEmployeeId
		{
			...
			set	{ SetValue((int)WorkOrderEmployeeFieldIndex.WorkOrderEmployeeId, value); }
		}
		...
		public virtual System.Int32 WorkOrderId
		{
			...
			set	{ SetValue((int)WorkOrderEmployeeFieldIndex.WorkOrderId, value); }
		}
		...
		public virtual System.Int32 EmployeeId
		{
			...
			set	{ SetValue((int)WorkOrderEmployeeFieldIndex.EmployeeId, value); }
		}
		...
		public virtual System.String Notes
		{
			...
			set	{ SetValue((int)WorkOrderEmployeeFieldIndex.Notes, value); }
		}
		...
		public virtual System.String UncategorizedItems
		{
			...
			set	{ SetValue((int)WorkOrderEmployeeFieldIndex.UncategorizedItems, value); }
		}
			...
			set
			{
				...
				else
				{
					...
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "WorkOrderEmployee");
						}
					}
				}
			}
