...
namespace Reliant.RenuOil.DAL.EntityClasses
{
			...
			
	{
		...
		public LoadEntity():base("LoadEntity")
		{
		...
		public LoadEntity(IEntityFields2 fields):base("LoadEntity")
		{
		...
		public LoadEntity(IValidator validator):base("LoadEntity")
		{
		...
		public LoadEntity(System.Int32 loadId):base("LoadEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.LoadId = loadId;
		}
		...
		/// <param name="validator">The custom validator object for this LoadEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public LoadEntity(System.Int32 loadId, IValidator validator):base("LoadEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.LoadId = loadId;
		}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entity of type 'Status' to this entity. Use DataAccessAdapter.FetchNewEntity() to fetch this related entity.</summary>
		/// <returns></returns>
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(LoadEntityFactory));
		}
#if !CF
		...
		private void SetupSyncEmployee(IEntity2 relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", LoadEntity.Relations.EmployeeEntityUsingEmployeeId, true, new string[] {  } );
			}
		}
		...
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncStatus(IEntity2 relatedEntity)
		{
			if(_status!=relatedEntity)
			{
				DesetupSyncStatus(true, true);
				_status = (StatusEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _status, new PropertyChangedEventHandler( OnStatusPropertyChanged ), "Status", LoadEntity.Relations.StatusEntityUsingStatusId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmployee
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),
					(IEntityRelation)GetRelationsForField("Employee")[0], (int)Reliant.RenuOil.DAL.EntityType.LoadEntity, (int)Reliant.RenuOil.DAL.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathStatus
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StatusEntityFactory))),
					(IEntityRelation)GetRelationsForField("Status")[0], (int)Reliant.RenuOil.DAL.EntityType.LoadEntity, (int)Reliant.RenuOil.DAL.EntityType.StatusEntity, 0, null, null, null, null, "Status", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public virtual System.Int32 LoadId
		{
			...
			set	{ SetValue((int)LoadFieldIndex.LoadId, value); }
		}
		...
		public virtual System.Int32 EmployeeId
		{
			...
			set	{ SetValue((int)LoadFieldIndex.EmployeeId, value); }
		}
		...
		public virtual System.DateTime Date
		{
			...
			set	{ SetValue((int)LoadFieldIndex.Date, value); }
		}
		...
		public virtual System.Int32 StatusId
		{
			...
			set	{ SetValue((int)LoadFieldIndex.StatusId, value); }
		}
			...
			set
			{
				...
				else
				{
					...
					else
					{
						if(_employee!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "Load");
						}
					}
				}
			}
		...
		/// <summary> Gets / sets related entity of type 'StatusEntity' which has to be set using a fetch action earlier. If no related entity
		/// is set for this property, null is returned. This property is not visible in databound grids.</summary>
		[Browsable(false)]
