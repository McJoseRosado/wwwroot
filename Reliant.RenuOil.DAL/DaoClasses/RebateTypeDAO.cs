...
namespace Reliant.RenuOil.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the RebateType Entity. It will perform database oriented actions for
	/// a entity of type 'RebateTypeEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class RebateTypeDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public RebateTypeDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "RebateTypeEntity", new RebateTypeEntityFactory())
		{
		}
		...
		internal RebateTypeDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'RebateTypeEntity' in a datatable which match the specified filter. 
