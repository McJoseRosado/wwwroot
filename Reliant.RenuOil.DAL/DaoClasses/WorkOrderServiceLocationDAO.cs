...
namespace Reliant.RenuOil.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the WorkOrderServiceLocation Entity. It will perform database oriented actions for
	/// a entity of type 'WorkOrderServiceLocationEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class WorkOrderServiceLocationDAO : DaoBase
	{
		...
		internal WorkOrderServiceLocationDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves in the calling WorkOrderServiceLocationCollection object all WorkOrderServiceLocationEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IPredicateExpression filter, IEntity serviceLocationInstance, IEntity workOrderInstance, int pageNumber, int pageSize)
		{
			...
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity);
		...
		/// <summary>
		/// Retrieves entities of the type 'WorkOrderServiceLocationEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Retrieves in the calling WorkOrderServiceLocationCollection object all WorkOrderServiceLocationEntity objects
		...
		public bool GetMultiUsingDeepFryerCollectionViaDeepFryerService(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity deepFryerInstance, int pageNumber, int pageSize)
		{
			...
			relations.Add(WorkOrderServiceLocationEntity.Relations.DeepFryerServiceEntityUsingWorkOrderServiceLocationId, "DeepFryerService_");
		...
		public bool GetMultiUsingServiceLocationAssetTypeCollectionViaAssetReclamationService(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity serviceLocationAssetTypeInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(WorkOrderServiceLocationEntity.Relations.AssetReclamationServiceEntityUsingWorkOrderServiceLocationId, "AssetReclamationService_");
		...
		/// <summary>
		/// Deletes from the persistent storage all 'WorkOrderServiceLocation' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="serviceLocationInstance">ServiceLocationEntity instance to use as a filter for the WorkOrderServiceLocationEntity objects to delete</param>
		/// <param name="workOrderInstance">WorkOrderEntity instance to use as a filter for the WorkOrderServiceLocationEntity objects to delete</param>
		...
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(Reliant.RenuOil.DAL.EntityType.WorkOrderServiceLocationEntity);
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="serviceLocationInstance">ServiceLocationEntity instance to use as a filter for the WorkOrderServiceLocationEntity objects to update</param>
		/// <param name="workOrderInstance">WorkOrderEntity instance to use as a filter for the WorkOrderServiceLocationEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// </summary>
		/// <param name="serviceLocationInstance">ServiceLocationEntity instance to use as a filter for the WorkOrderServiceLocationEntity objects</param>
		/// <param name="workOrderInstance">WorkOrderEntity instance to use as a filter for the WorkOrderServiceLocationEntity objects</param>
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(IEntity serviceLocationInstance, IEntity workOrderInstance, IEntityFields fieldsToReturn)
		{
			...
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)WorkOrderServiceLocationFieldIndex.ServiceLocationId], ComparisonOperator.Equal, ((ServiceLocationEntity)serviceLocationInstance).ServiceLocationId));
			}
			if(workOrderInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)WorkOrderServiceLocationFieldIndex.WorkOrderId], ComparisonOperator.Equal, ((WorkOrderEntity)workOrderInstance).WorkOrderId));
			}
			return selectFilter;
		}
