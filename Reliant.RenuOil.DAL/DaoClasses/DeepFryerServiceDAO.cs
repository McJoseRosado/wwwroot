...
namespace Reliant.RenuOil.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the DeepFryerService Entity. It will perform database oriented actions for
	/// a entity of type 'DeepFryerServiceEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class DeepFryerServiceDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public DeepFryerServiceDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "DeepFryerServiceEntity", new DeepFryerServiceEntityFactory())
		{
		}
		...
		internal DeepFryerServiceDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves in the calling DeepFryerServiceCollection object all DeepFryerServiceEntity objects which have data in common
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IPredicateExpression filter, IEntity deepFryerInstance, IEntity employeeInstance, IEntity serviceLocationInstance, IEntity workOrderEmployeeInstance, IEntity workOrderServiceLocationInstance, int pageNumber, int pageSize)
		{
			...
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(deepFryerInstance, employeeInstance, serviceLocationInstance, workOrderEmployeeInstance, workOrderServiceLocationInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		/// <summary>
		/// Retrieves entities of the type 'DeepFryerServiceEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'DeepFryerService' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="deepFryerInstance">DeepFryerEntity instance to use as a filter for the DeepFryerServiceEntity objects to delete</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the DeepFryerServiceEntity objects to delete</param>
		/// <param name="serviceLocationInstance">ServiceLocationEntity instance to use as a filter for the DeepFryerServiceEntity objects to delete</param>
		/// <param name="workOrderEmployeeInstance">WorkOrderEmployeeEntity instance to use as a filter for the DeepFryerServiceEntity objects to delete</param>
		/// <param name="workOrderServiceLocationInstance">WorkOrderServiceLocationEntity instance to use as a filter for the DeepFryerServiceEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, IEntity deepFryerInstance, IEntity employeeInstance, IEntity serviceLocationInstance, IEntity workOrderEmployeeInstance, IEntity workOrderServiceLocationInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(Reliant.RenuOil.DAL.EntityType.DeepFryerServiceEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(deepFryerInstance, employeeInstance, serviceLocationInstance, workOrderEmployeeInstance, workOrderServiceLocationInstance, fields);
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="deepFryerInstance">DeepFryerEntity instance to use as a filter for the DeepFryerServiceEntity objects to update</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the DeepFryerServiceEntity objects to update</param>
		/// <param name="serviceLocationInstance">ServiceLocationEntity instance to use as a filter for the DeepFryerServiceEntity objects to update</param>
		/// <param name="workOrderEmployeeInstance">WorkOrderEmployeeEntity instance to use as a filter for the DeepFryerServiceEntity objects to update</param>
		/// <param name="workOrderServiceLocationInstance">WorkOrderServiceLocationEntity instance to use as a filter for the DeepFryerServiceEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntity entityWithNewValues, ITransaction containingTransaction, IEntity deepFryerInstance, IEntity employeeInstance, IEntity serviceLocationInstance, IEntity workOrderEmployeeInstance, IEntity workOrderServiceLocationInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(Reliant.RenuOil.DAL.EntityType.DeepFryerServiceEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(deepFryerInstance, employeeInstance, serviceLocationInstance, workOrderEmployeeInstance, workOrderServiceLocationInstance, fields);
		...
		/// </summary>
		/// <param name="deepFryerInstance">DeepFryerEntity instance to use as a filter for the DeepFryerServiceEntity objects</param>
		/// <param name="employeeInstance">EmployeeEntity instance to use as a filter for the DeepFryerServiceEntity objects</param>
		/// <param name="serviceLocationInstance">ServiceLocationEntity instance to use as a filter for the DeepFryerServiceEntity objects</param>
		/// <param name="workOrderEmployeeInstance">WorkOrderEmployeeEntity instance to use as a filter for the DeepFryerServiceEntity objects</param>
		/// <param name="workOrderServiceLocationInstance">WorkOrderServiceLocationEntity instance to use as a filter for the DeepFryerServiceEntity objects</param>
		/// <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		/// <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		private IPredicateExpression CreateFilterUsingForeignKeys(IEntity deepFryerInstance, IEntity employeeInstance, IEntity serviceLocationInstance, IEntity workOrderEmployeeInstance, IEntity workOrderServiceLocationInstance, IEntityFields fieldsToReturn)
		{
			IPredicateExpression selectFilter = new PredicateExpression();
			
			if(deepFryerInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)DeepFryerServiceFieldIndex.DeepFryerId], ComparisonOperator.Equal, ((DeepFryerEntity)deepFryerInstance).DeepFryerId));
			}
			if(employeeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)DeepFryerServiceFieldIndex.Servicedby], ComparisonOperator.Equal, ((EmployeeEntity)employeeInstance).EmployeeId));
			}
			if(serviceLocationInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)DeepFryerServiceFieldIndex.RelocatedToServiceLocationId], ComparisonOperator.Equal, ((ServiceLocationEntity)serviceLocationInstance).ServiceLocationId));
			}
			if(workOrderEmployeeInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)DeepFryerServiceFieldIndex.WorkOrderServiceLocationId], ComparisonOperator.Equal, ((WorkOrderEmployeeEntity)workOrderEmployeeInstance).WorkOrderEmployeeId));
			}
			if(workOrderServiceLocationInstance != null)
			{
				selectFilter.Add(new FieldCompareValuePredicate(fieldsToReturn[(int)DeepFryerServiceFieldIndex.WorkOrderServiceLocationId], ComparisonOperator.Equal, ((WorkOrderServiceLocationEntity)workOrderServiceLocationInstance).WorkOrderServiceLocationId));
			}
			return selectFilter;
		}
