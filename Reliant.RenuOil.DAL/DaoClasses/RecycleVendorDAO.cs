...
namespace Reliant.RenuOil.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the RecycleVendor Entity. It will perform database oriented actions for
	/// a entity of type 'RecycleVendorEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class RecycleVendorDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public RecycleVendorDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "RecycleVendorEntity", new RecycleVendorEntityFactory())
		{
		}
		...
		internal RecycleVendorDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
