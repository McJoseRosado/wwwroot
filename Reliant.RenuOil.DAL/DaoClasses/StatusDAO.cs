...
namespace Reliant.RenuOil.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Status Entity. It will perform database oriented actions for
	/// a entity of type 'StatusEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class StatusDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public StatusDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "StatusEntity", new StatusEntityFactory())
		{
		}
		...
		internal StatusDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'StatusEntity' in a datatable which match the specified filter. 
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingEmployeeCollectionViaLoad(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity employeeInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(Reliant.RenuOil.DAL.EntityType.StatusEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(StatusEntity.Relations.LoadEntityUsingStatusId, "Load_");
