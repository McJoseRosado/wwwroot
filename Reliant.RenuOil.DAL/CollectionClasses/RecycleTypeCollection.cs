...
namespace Reliant.RenuOil.DAL.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of RecycleTypeEntity objects. </summary>
	[Serializable]
	public partial class RecycleTypeCollection : EntityCollectionBase<RecycleTypeEntity>
	{
		/// <summary> CTor</summary>
		public RecycleTypeCollection():base(new RecycleTypeEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public RecycleTypeCollection(IList<RecycleTypeEntity> initialContents):base(new RecycleTypeEntityFactory())
		{
		...
		public RecycleTypeCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected RecycleTypeCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}



		/// <summary> Retrieves in this RecycleTypeCollection object all RecycleTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in AccountEntity. 
		...
		public bool GetMultiManyToManyUsingAccountCollectionViaRecycleVendorService(IEntity accountInstance)
		{
			return GetMultiManyToManyUsingAccountCollectionViaRecycleVendorService(accountInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaRecycleVendorService(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingAccountCollectionViaRecycleVendorService(accountInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingAccountCollectionViaRecycleVendorService(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			}
			RecycleTypeDAO dao = DAOFactory.CreateRecycleTypeDAO();
			return dao.GetMultiUsingAccountCollectionViaRecycleVendorService(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, accountInstance, pageNumber, pageSize);
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaRecycleVendorService(IEntity accountInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingAccountCollectionViaRecycleVendorService(accountInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaRecycleVendorService(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			RecycleTypeDAO dao = DAOFactory.CreateRecycleTypeDAO();
			return dao.GetMultiUsingAccountCollectionViaRecycleVendorService(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, accountInstance, prefetchPathToUse);
		}
		...
		/// <param name="accountInstance">AccountEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaBale(IEntity accountInstance)
		{
			return GetMultiManyToManyUsingAccountCollectionViaBale(accountInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaBale(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingAccountCollectionViaBale(accountInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingAccountCollectionViaBale(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			RecycleTypeDAO dao = DAOFactory.CreateRecycleTypeDAO();
			return dao.GetMultiUsingAccountCollectionViaBale(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, accountInstance, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaBale(IEntity accountInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingAccountCollectionViaBale(accountInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaBale(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			RecycleTypeDAO dao = DAOFactory.CreateRecycleTypeDAO();
			return dao.GetMultiUsingAccountCollectionViaBale(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, accountInstance, prefetchPathToUse);
		}

		/// <summary> Retrieves in this RecycleTypeCollection object all RecycleTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in DockEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this RecycleTypeCollection object all RecycleTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in EmployeeEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this RecycleTypeCollection object all RecycleTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in RecycleServiceEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this RecycleTypeCollection object all RecycleTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in RecycleVendorEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this RecycleTypeCollection object all RecycleTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in ServiceLocationEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		/// <param name="serviceLocationInstance">ServiceLocationEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingServiceLocationCollectionViaServiceLocationRecycleType(IEntity serviceLocationInstance)
		{
			return GetMultiManyToManyUsingServiceLocationCollectionViaServiceLocationRecycleType(serviceLocationInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingServiceLocationCollectionViaServiceLocationRecycleType(IEntity serviceLocationInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingServiceLocationCollectionViaServiceLocationRecycleType(serviceLocationInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingServiceLocationCollectionViaServiceLocationRecycleType(IEntity serviceLocationInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			RecycleTypeDAO dao = DAOFactory.CreateRecycleTypeDAO();
			return dao.GetMultiUsingServiceLocationCollectionViaServiceLocationRecycleType(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, serviceLocationInstance, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingServiceLocationCollectionViaServiceLocationRecycleType(IEntity serviceLocationInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingServiceLocationCollectionViaServiceLocationRecycleType(serviceLocationInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingServiceLocationCollectionViaServiceLocationRecycleType(IEntity serviceLocationInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			RecycleTypeDAO dao = DAOFactory.CreateRecycleTypeDAO();
			return dao.GetMultiUsingServiceLocationCollectionViaServiceLocationRecycleType(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, serviceLocationInstance, prefetchPathToUse);
		}

		/// <summary> Retrieves in this RecycleTypeCollection object all RecycleTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in UserEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		public object GetScalar(RecycleTypeFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(RecycleTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(RecycleTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(RecycleTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(RecycleTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
