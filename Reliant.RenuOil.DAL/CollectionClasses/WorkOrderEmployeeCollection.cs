...
namespace Reliant.RenuOil.DAL.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of WorkOrderEmployeeEntity objects. </summary>
	[Serializable]
	public partial class WorkOrderEmployeeCollection : EntityCollectionBase<WorkOrderEmployeeEntity>
	{
		/// <summary> CTor</summary>
		public WorkOrderEmployeeCollection():base(new WorkOrderEmployeeEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public WorkOrderEmployeeCollection(IList<WorkOrderEmployeeEntity> initialContents):base(new WorkOrderEmployeeEntityFactory())
		{
		...
		public WorkOrderEmployeeCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected WorkOrderEmployeeCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}


		/// <summary> Retrieves in this WorkOrderEmployeeCollection object all WorkOrderEmployeeEntity objects which have data in common with the specified related Entities.
		...
		public virtual bool GetMultiManyToOne(IEntity serviceLocationInstance, IEntity workOrderInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			WorkOrderEmployeeDAO dao = DAOFactory.CreateWorkOrderEmployeeDAO();
		...
		/// <summary> Deletes from the persistent storage all WorkOrderEmployee entities which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter.</summary>
		...
		/// <summary> Updates in the persistent storage all WorkOrderEmployee entities which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter.
		/// Which fields are updated in those matching entities depends on which fields are <i>changed</i> in the passed in entity entityWithNewValues. The new values of these fields are read from entityWithNewValues. </summary>
		/// <param name="entityWithNewValues">WorkOrderEmployeeEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		/// <param name="serviceLocationInstance">ServiceLocationEntity instance to use as a filter for the WorkOrderEmployeeEntity objects to return</param>
		/// <param name="workOrderInstance">WorkOrderEntity instance to use as a filter for the WorkOrderEmployeeEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(WorkOrderEmployeeEntity entityWithNewValues, IEntity serviceLocationInstance, IEntity workOrderInstance)
		{
			WorkOrderEmployeeDAO dao = DAOFactory.CreateWorkOrderEmployeeDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, serviceLocationInstance, workOrderInstance);
		}

		/// <summary> Retrieves in this WorkOrderEmployeeCollection object all WorkOrderEmployeeEntity objects which are related via a  Relation of type 'm:n' with the passed in DeepFryerEntity. 
		...
		/// <summary> Retrieves in this WorkOrderEmployeeCollection object all WorkOrderEmployeeEntity objects which are related via a  Relation of type 'm:n' with the passed in EmployeeEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this WorkOrderEmployeeCollection object all WorkOrderEmployeeEntity objects which are related via a  Relation of type 'm:n' with the passed in ServiceLocationEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this WorkOrderEmployeeCollection object all WorkOrderEmployeeEntity objects which are related via a  Relation of type 'm:n' with the passed in ServiceLocationAssetTypeEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		public object GetScalar(WorkOrderEmployeeFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(WorkOrderEmployeeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(WorkOrderEmployeeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(WorkOrderEmployeeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(WorkOrderEmployeeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
