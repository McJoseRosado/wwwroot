...
namespace Reliant.RenuOil.DAL.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of UserAccountEntity objects. </summary>
	[Serializable]
	public partial class UserAccountCollection : EntityCollectionBase<UserAccountEntity>
	{
		/// <summary> CTor</summary>
		public UserAccountCollection():base(new UserAccountEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public UserAccountCollection(IList<UserAccountEntity> initialContents):base(new UserAccountEntityFactory())
		{
		...
		public UserAccountCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected UserAccountCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		public bool GetMultiManyToOne(IEntity accountInstance, IEntity userInstance)
		{
			return GetMultiManyToOne(accountInstance, userInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity accountInstance, IEntity userInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(accountInstance, userInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity accountInstance, IEntity userInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(accountInstance, userInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		public object GetScalar(UserAccountFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(UserAccountFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(UserAccountFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(UserAccountFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		{
			return DAOFactory.CreateUserAccountDAO();
		}
