...
namespace Reliant.RenuOil.DAL.CollectionClasses
{
	...
	public partial class UserCollection : EntityCollectionBase<UserEntity>
	{
		...
		public bool GetMultiManyToOne(IEntity userTypeInstance)
		{
			return GetMultiManyToOne(userTypeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity userTypeInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(userTypeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity userTypeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(userTypeInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity userTypeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			bool validParameters = false;
			validParameters |= (userTypeInstance!=null);
			if(!validParameters)
			{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, filter, userTypeInstance, pageNumber, pageSize);
		}
		...
		public int DeleteMultiManyToOne(IEntity userTypeInstance)
		{
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.DeleteMulti(base.Transaction, userTypeInstance);
		}
		...
		/// <param name="userTypeInstance">UserTypeEntity instance to use as a filter for the UserEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(UserEntity entityWithNewValues, IEntity userTypeInstance)
		{
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, userTypeInstance);
		}

		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in AccountEntity. 
		...
		/// <param name="accountInstance">AccountEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaUserAccount(IEntity accountInstance)
		{
			return GetMultiManyToManyUsingAccountCollectionViaUserAccount(accountInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaUserAccount(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingAccountCollectionViaUserAccount(accountInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingAccountCollectionViaUserAccount(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.GetMultiUsingAccountCollectionViaUserAccount(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, accountInstance, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaUserAccount(IEntity accountInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingAccountCollectionViaUserAccount(accountInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingAccountCollectionViaUserAccount(IEntity accountInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.GetMultiUsingAccountCollectionViaUserAccount(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, accountInstance, prefetchPathToUse);
		}

		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in AssetReclamationServiceEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in ChangeTypeEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		/// <param name="changeTypeInstance">ChangeTypeEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingChangeTypeCollectionViaChangeLog(IEntity changeTypeInstance)
		{
			return GetMultiManyToManyUsingChangeTypeCollectionViaChangeLog(changeTypeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingChangeTypeCollectionViaChangeLog(IEntity changeTypeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingChangeTypeCollectionViaChangeLog(changeTypeInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingChangeTypeCollectionViaChangeLog(IEntity changeTypeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.GetMultiUsingChangeTypeCollectionViaChangeLog(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, changeTypeInstance, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingChangeTypeCollectionViaChangeLog(IEntity changeTypeInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingChangeTypeCollectionViaChangeLog(changeTypeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingChangeTypeCollectionViaChangeLog(IEntity changeTypeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.GetMultiUsingChangeTypeCollectionViaChangeLog(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, changeTypeInstance, prefetchPathToUse);
		}

		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in DeepFryerServiceEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in EmployeeEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <param name="employeeInstance">EmployeeEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction___(IEntity employeeInstance)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction___(employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction___(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction___(employeeInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction___(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.GetMultiUsingEmployeeCollectionViaRecycleServiceAction___(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, employeeInstance, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction___(IEntity employeeInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction___(employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction___(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.GetMultiUsingEmployeeCollectionViaRecycleServiceAction___(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, employeeInstance, prefetchPathToUse);
		}
		...
		/// <param name="employeeInstance">EmployeeEntity object to be used as a filter in the m:n relation</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction__(IEntity employeeInstance)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction__(employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, 0, 0);
		}
		...
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction__(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction__(employeeInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0);
		}
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction__(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.GetMultiUsingEmployeeCollectionViaRecycleServiceAction__(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, employeeInstance, pageNumber, pageSize);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction__(IEntity employeeInstance, IPrefetchPath prefetchPathToUse)
		{
			return GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction__(employeeInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, prefetchPathToUse);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingEmployeeCollectionViaRecycleServiceAction__(IEntity employeeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPrefetchPath prefetchPathToUse)
		{
			if(!base.SuppressClearInGetMulti)
			{
				this.Clear();
			...
			UserDAO dao = DAOFactory.CreateUserDAO();
			return dao.GetMultiUsingEmployeeCollectionViaRecycleServiceAction__(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, employeeInstance, prefetchPathToUse);
		}
		...
		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in RebateTypeEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in RecycleServiceEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in RecycleTypeEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Retrieves in this UserCollection object all UserEntity objects which are related via a  Relation of type 'm:n' with the passed in ServiceLocationEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
