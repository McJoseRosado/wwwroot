...
namespace Reliant.RenuOil.DAL.HelperClasses
{
	...
	internal class FieldInfoProviderCore : FieldInfoProviderBase
	{
		...
		private void InitBaleEntityInfos()
		{
			...
			base.AddElementFieldInfo("BaleEntity", "BaleNumber", typeof(Nullable<System.Int32>), false, false, false, true,  (int)BaleFieldIndex.BaleNumber, 0, 0, 10);
			base.AddElementFieldInfo("BaleEntity", "IsActive", typeof(System.Boolean), false, false, false, false,  (int)BaleFieldIndex.IsActive, 0, 0, 0);
		}
		...
		private void InitDockEntityInfos()
		{
			...
			base.AddElementFieldInfo("DockEntity", "DockName", typeof(System.String), false, false, false, false,  (int)DockFieldIndex.DockName, 20, 0, 0);
			base.AddElementFieldInfo("DockEntity", "IsActive", typeof(System.Boolean), false, false, false, false,  (int)DockFieldIndex.IsActive, 0, 0, 0);
		}
		/// <summary>Inits ElmahErrorEntity's FieldInfo objects</summary>
		private void InitElmahErrorEntityInfos()
		{
			base.AddElementFieldInfo("ElmahErrorEntity", "ErrorId", typeof(System.Guid), true, false, false, false,  (int)ElmahErrorFieldIndex.ErrorId, 0, 0, 0);
			base.AddElementFieldInfo("ElmahErrorEntity", "Application", typeof(System.String), false, false, false, false,  (int)ElmahErrorFieldIndex.Application, 60, 0, 0);
			base.AddElementFieldInfo("ElmahErrorEntity", "Host", typeof(System.String), false, false, false, false,  (int)ElmahErrorFieldIndex.Host, 50, 0, 0);
			base.AddElementFieldInfo("ElmahErrorEntity", "Type", typeof(System.String), false, false, false, false,  (int)ElmahErrorFieldIndex.Type, 100, 0, 0);
			base.AddElementFieldInfo("ElmahErrorEntity", "Source", typeof(System.String), false, false, false, false,  (int)ElmahErrorFieldIndex.Source, 60, 0, 0);
			base.AddElementFieldInfo("ElmahErrorEntity", "Message", typeof(System.String), false, false, false, false,  (int)ElmahErrorFieldIndex.Message, 500, 0, 0);
			base.AddElementFieldInfo("ElmahErrorEntity", "User", typeof(System.String), false, false, false, false,  (int)ElmahErrorFieldIndex.User, 50, 0, 0);
			base.AddElementFieldInfo("ElmahErrorEntity", "StatusCode", typeof(System.Int32), false, false, false, false,  (int)ElmahErrorFieldIndex.StatusCode, 0, 0, 10);
			base.AddElementFieldInfo("ElmahErrorEntity", "TimeUtc", typeof(System.DateTime), false, false, false, false,  (int)ElmahErrorFieldIndex.TimeUtc, 0, 0, 0);
			base.AddElementFieldInfo("ElmahErrorEntity", "Sequence", typeof(System.Int32), false, false, true, false,  (int)ElmahErrorFieldIndex.Sequence, 0, 0, 10);
			base.AddElementFieldInfo("ElmahErrorEntity", "AllXml", typeof(System.String), false, false, false, false,  (int)ElmahErrorFieldIndex.AllXml, 1073741823, 0, 0);
		}
		...
		private void InitLoadEntityInfos()
		{
			...
			base.AddElementFieldInfo("LoadEntity", "LoadNumber", typeof(Nullable<System.Int32>), false, false, false, true,  (int)LoadFieldIndex.LoadNumber, 0, 0, 10);
			base.AddElementFieldInfo("LoadEntity", "IsActive", typeof(System.Boolean), false, false, false, false,  (int)LoadFieldIndex.IsActive, 0, 0, 0);
		}
