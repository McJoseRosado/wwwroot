...
namespace Reliant.RenuOil.DAL.HelperClasses
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			base.AddElementMapping( "AccountEntity", "DB_100791_renuoil", @"dbo", "Account", 13 );
		...
		{
			base.AddElementMapping( "AccountEmployeeAssignmentEntity", "DB_100791_renuoil", @"dbo", "AccountEmployeeAssignment", 9 );
		...
		{
			base.AddElementMapping( "AssetCategoryEntity", "DB_100791_renuoil", @"dbo", "AssetCategory", 5 );
		...
		{
			base.AddElementMapping( "AssetReclamationServiceEntity", "DB_100791_renuoil", @"dbo", "AssetReclamationService", 4 );
		...
		{
			base.AddElementMapping( "AssetReclamationServiceChangeLogEntity", "DB_100791_renuoil", @"dbo", "AssetReclamationServiceChangeLog", 6 );
		...
		{
			base.AddElementMapping( "AssetTypeEntity", "DB_100791_renuoil", @"dbo", "AssetType", 6 );
		...
		{
			base.AddElementMapping( "BaleEntity", "DB_100791_renuoil", @"dbo", "Bale", 12 );
			...
			base.AddElementFieldMapping( "BaleEntity", "BaleNumber", "BaleNumber", true, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 10 );
			base.AddElementFieldMapping( "BaleEntity", "IsActive", "IsActive", false, (int)SqlDbType.Bit, 0, 0, 0, false, "", null, typeof(System.Boolean), 11 );
		}
		/// <summary>Inits ChangeLogEntity's mappings</summary>
		private void InitChangeLogEntityMappings()
		{
			base.AddElementMapping( "ChangeLogEntity", "DB_100791_renuoil", @"dbo", "ChangeLog", 4 );
		...
		{
			base.AddElementMapping( "ChangeTypeEntity", "DB_100791_renuoil", @"dbo", "ChangeType", 3 );
		...
		{
			base.AddElementMapping( "DeepFryerEntity", "DB_100791_renuoil", @"dbo", "DeepFryer", 6 );
		...
		{
			base.AddElementMapping( "DeepFryerChangeLogEntity", "DB_100791_renuoil", @"dbo", "DeepFryerChangeLog", 3 );
		...
		{
			base.AddElementMapping( "DeepFryerServiceEntity", "DB_100791_renuoil", @"dbo", "DeepFryerService", 13 );
		...
		{
			base.AddElementMapping( "DeepFryerServiceChangeLogEntity", "DB_100791_renuoil", @"dbo", "DeepFryerServiceChangeLog", 14 );
		...
		{
			base.AddElementMapping( "DockEntity", "DB_100791_renuoil", @"dbo", "Dock", 4 );
			...
			base.AddElementFieldMapping( "DockEntity", "DockName", "DockName", false, (int)SqlDbType.NVarChar, 20, 0, 0, false, "", null, typeof(System.String), 2 );
			base.AddElementFieldMapping( "DockEntity", "IsActive", "IsActive", false, (int)SqlDbType.Bit, 0, 0, 0, false, "", null, typeof(System.Boolean), 3 );
		}
		/// <summary>Inits ElmahErrorEntity's mappings</summary>
		private void InitElmahErrorEntityMappings()
		{
			base.AddElementMapping( "ElmahErrorEntity", "DB_100791_renuoil", @"dbo", "ELMAH_Error", 11 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "ErrorId", "ErrorId", false, (int)SqlDbType.UniqueIdentifier, 0, 0, 0, false, "", null, typeof(System.Guid), 0 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "Application", "Application", false, (int)SqlDbType.NVarChar, 60, 0, 0, false, "", null, typeof(System.String), 1 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "Host", "Host", false, (int)SqlDbType.NVarChar, 50, 0, 0, false, "", null, typeof(System.String), 2 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "Type", "Type", false, (int)SqlDbType.NVarChar, 100, 0, 0, false, "", null, typeof(System.String), 3 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "Source", "Source", false, (int)SqlDbType.NVarChar, 60, 0, 0, false, "", null, typeof(System.String), 4 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "Message", "Message", false, (int)SqlDbType.NVarChar, 500, 0, 0, false, "", null, typeof(System.String), 5 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "User", "User", false, (int)SqlDbType.NVarChar, 50, 0, 0, false, "", null, typeof(System.String), 6 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "StatusCode", "StatusCode", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 7 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "TimeUtc", "TimeUtc", false, (int)SqlDbType.DateTime, 0, 0, 0, false, "", null, typeof(System.DateTime), 8 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "Sequence", "Sequence", false, (int)SqlDbType.Int, 0, 0, 10, true, "SCOPE_IDENTITY()", null, typeof(System.Int32), 9 );
			base.AddElementFieldMapping( "ElmahErrorEntity", "AllXml", "AllXml", false, (int)SqlDbType.NText, 1073741823, 0, 0, false, "", null, typeof(System.String), 10 );
		}
		/// <summary>Inits EmployeeEntity's mappings</summary>
		private void InitEmployeeEntityMappings()
		{
			base.AddElementMapping( "EmployeeEntity", "DB_100791_renuoil", @"dbo", "Employee", 22 );
		...
		{
			base.AddElementMapping( "LoadEntity", "DB_100791_renuoil", @"dbo", "Load", 6 );
			...
			base.AddElementFieldMapping( "LoadEntity", "LoadNumber", "LoadNumber", true, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 4 );
			base.AddElementFieldMapping( "LoadEntity", "IsActive", "IsActive", false, (int)SqlDbType.Bit, 0, 0, 0, false, "", null, typeof(System.Boolean), 5 );
		}
		/// <summary>Inits MobileDeviceEntity's mappings</summary>
		private void InitMobileDeviceEntityMappings()
		{
			base.AddElementMapping( "MobileDeviceEntity", "DB_100791_renuoil", @"dbo", "MobileDevice", 5 );
		...
		{
			base.AddElementMapping( "RebateEntity", "DB_100791_renuoil", @"dbo", "Rebate", 7 );
		...
		{
			base.AddElementMapping( "RebateTypeEntity", "DB_100791_renuoil", @"dbo", "RebateType", 3 );
		...
		{
			base.AddElementMapping( "RecycleServiceEntity", "DB_100791_renuoil", @"dbo", "RecycleService", 6 );
		...
		{
			base.AddElementMapping( "RecycleServiceActionEntity", "DB_100791_renuoil", @"dbo", "RecycleServiceAction", 14 );
		...
		{
			base.AddElementMapping( "RecycleServiceChangeLogEntity", "DB_100791_renuoil", @"dbo", "RecycleServiceChangeLog", 9 );
		...
		{
			base.AddElementMapping( "RecycleTypeEntity", "DB_100791_renuoil", @"dbo", "RecycleType", 5 );
		...
		{
			base.AddElementMapping( "RecycleVendorEntity", "DB_100791_renuoil", @"dbo", "RecycleVendor", 4 );
		...
		{
			base.AddElementMapping( "RecycleVendorServiceEntity", "DB_100791_renuoil", @"dbo", "RecycleVendorService", 8 );
		...
		{
			base.AddElementMapping( "ServiceLocationEntity", "DB_100791_renuoil", @"dbo", "ServiceLocation", 15 );
		...
		{
			base.AddElementMapping( "ServiceLocationAssetTypeEntity", "DB_100791_renuoil", @"dbo", "ServiceLocationAssetType", 4 );
		...
		{
			base.AddElementMapping( "ServiceLocationAssetTypeChangeLogEntity", "DB_100791_renuoil", @"dbo", "ServiceLocationAssetTypeChangeLog", 3 );
		...
		{
			base.AddElementMapping( "ServiceLocationEmployeeAssignmentEntity", "DB_100791_renuoil", @"dbo", "ServiceLocationEmployeeAssignment", 9 );
		...
		{
			base.AddElementMapping( "ServiceLocationRecycleTypeEntity", "DB_100791_renuoil", @"dbo", "ServiceLocationRecycleType", 4 );
		...
		{
			base.AddElementMapping( "ServiceTypeEntity", "DB_100791_renuoil", @"dbo", "ServiceType", 3 );
		...
		{
			base.AddElementMapping( "SettingEntity", "DB_100791_renuoil", @"dbo", "Setting", 6 );
		...
		{
			base.AddElementMapping( "StatusEntity", "DB_100791_renuoil", @"dbo", "Status", 2 );
		...
		{
			base.AddElementMapping( "UserEntity", "DB_100791_renuoil", @"dbo", "User", 10 );
		...
		{
			base.AddElementMapping( "UserAccountEntity", "DB_100791_renuoil", @"dbo", "UserAccount", 3 );
		...
		{
			base.AddElementMapping( "UserTypeEntity", "DB_100791_renuoil", @"dbo", "UserType", 3 );
		...
		{
			base.AddElementMapping( "WorkOrderEntity", "DB_100791_renuoil", @"dbo", "WorkOrder", 10 );
		...
		{
			base.AddElementMapping( "WorkOrderEmployeeEntity", "DB_100791_renuoil", @"dbo", "WorkOrderServiceLocation", 5 );
		...
		{
			base.AddElementMapping( "WorkOrderServiceLocationEntity", "DB_100791_renuoil", @"dbo", "WorkOrderServiceLocation", 5 );
